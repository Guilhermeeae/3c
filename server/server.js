...
app.use(express.static(path.join(__dirname, '../public'), {
  setHeaders: (res, path) => {
    // Service Worker deve ser servido com no-cache
...
// Registrar subscription no MongoDB com validação
app.post('/subscribe', async (req, res) => {
  ...
  try {
    // Detectar tipo de dispositivo para logs
...
// Enviar notificações com melhor tratamento de erros
...
// Dashboard aprimorado com autenticação e rate limiting
